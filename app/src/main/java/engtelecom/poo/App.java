...
public class App {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * // horizontal
         * yInicial = 180;
         * double[] xHorizontal = { 0.1 * fator + xInicial, 0.2 * fator + xInicial, 1.0
         * * fator + xInicial,
         * 1.1 * fator + xInicial, 1.0 * fator + xInicial, 0.2 * fator + xInicial };
         * double[] yHorizontal = { 0.2 * fator + yInicial, 0.3 * fator + yInicial, 0.3
         * * fator + yInicial,
         ...
         * vertical
         * yInicial = 200;
         * double[] xVertical = { 0.1 * fator + xInicial, 0.2 * fator + xInicial, 0.2 *
         * fator + xInicial,
         * 0.1 * fator + xInicial, 0 * fator + xInicial, 0 * fator + xInicial };
         * double[] yVertical = { 0.2 * fator + yInicial, 0.3 * fator + yInicial, 1.0 *
         * fator + yInicial,
